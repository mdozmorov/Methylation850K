...
diffMeth <- rnb.computeDiffMeth(rnb.set.norm, pheno.cols = "Visit")
...
quartz()
plot(diff.meth.prom[, "mean.mean.diff"], -log10(diff.meth.prom[, "comb.p.val"]), xlab="mean difference", ylab="-log10(combined p-value)", col="blue")
```
...
combinedRank100     <- diff.meth.proms.100$combinedRank[100]
combinedRank500     <- diff.meth.proms.100$combinedRank[500]
...
combinedRank100     <- diff.meth.genes.100$combinedRank[100]
combinedRank500     <- diff.meth.genes.100$combinedRank[500]
...
combinedRank100     <- diff.meth.cpgs.100$combinedRank[100]
combinedRank500     <- diff.meth.cpgs.100$combinedRank[500]
...
annotated.diff.meth.sites <- annotated.diff.meth.sites[order(annotated.diff.meth.sites$combinedRank, decreasing = FALSE), ]
which.diffmeth <- abs(annotated.diff.meth.sites[, "mean.diff"])>0.2 & annotated.diff.meth.sites$diffmeth.p.adj.fdr<0.05
annotated.diff.meth.sites <- annotated.diff.meth.sites[which.diffmeth, ]
